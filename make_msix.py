...
# --- MANIFEST FINAL 1.0.13.0 X64 ---
manifest = """<?xml version="1.0" encoding="utf-8"?>
<Package xmlns="http://schemas.microsoft.com/appx/manifest/foundation/windows10"
         xmlns:uap="http://schemas.microsoft.com/appx/manifest/uap/windows10"
         xmlns:rescap="http://schemas.microsoft.com/appx/manifest/foundation/windows10/restrictedcapabilities"
         IgnorableNamespaces="uap rescap">
  <Identity Name="Insiteva.INSITEVA" Publisher="CN=4D02E3C1-2496-4104-A71A-89481814EBE0" Version="1.0.14.0" ProcessorArchitecture="x64" />
  <Properties>
  ...
  <Applications>
    <Application Id="App" Executable="INSITEVA.exe" EntryPoint="Windows.FullTrustApplication">
      <uap:VisualElements DisplayName="INSITEVA" Description="INSITEVA Desktop App" BackgroundColor="#2D2D30" Square150x150Logo="assets\\Square150x150Logo.png" Square44x44Logo="assets\\SmallLogo.png" />
    </Application>
  </Applications>
  <Capabilities>
...
subprocess.check_call([makeappx, "pack", "/d", "msix_build", "/p", "INSITEVA_1.0.14.0_x64.msix", "/o"])
print("MSIX CREATED SUCCESSFULLY - X64")
